# __init__.py
from .common import printf,printf_check,random_str,get_abs_path,crop_to_square,add_append_img,math_convert_percent
...
from .test import get_process_memory_usage
...
__all__ = ["printf",'printf_check','random_str','download_img','deal_text_with_tag','get_abs_path','json_check','crop_to_square',
           ...
           'init','per_img_deal','final_img_deal','icon_backdrop_check','per_img_limit_deal','get_process_memory_usage','math_convert_percent'
           ]