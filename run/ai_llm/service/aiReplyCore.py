        ...
        if config.ai_llm.config["llm"]["群聊总结"]["聊天带总结"]:
            ...
            if group_summary:
                summary_text = (
                    ...
                    "================== 刚刚群里发生了什么 结束 ==================\n"
                    "⚠️【你的群聊社交潜意识】：\n"
                    "1. 你现在正处于有其他人在场的公开场合。请严格维持你本人的“公开社交人设”，注意社交边界，绝对不要出现“当众发情”或过度私密的大尺度发言。\n"
                    "2. 请根据上面的群聊总结“读空气”，理解当前的讨论话题和群聊氛围，让你的发言自然地融入情境，不要像个突兀的局外人。\n"
                    "3. 在群里，对待 {用户} 和对待“其他群友”，你的态度必须有微妙的差异（比如对 {用户} 更关注、有专属的默契、或者为了避嫌而故意拌嘴），具体取决于你的性格设定。\n"
                    "4. 遇到无法直接表达的情绪或私密想法，全部压抑到 (内心OS) 中，发出的 💬消息 必须符合你在公开场合的身份。"
                )
                if config.ai_llm.config["llm"]["model"] == "gemini":
                    summary_message = {
                        "role": "user",
